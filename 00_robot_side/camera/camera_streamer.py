...
Usage (via main.py):
    python -m camera.camera_streamer

Usage (standalone, run from 00_robot_side/):
...
To swap the pipeline (no other code changes needed):
    from camera.frame_source import YOLODetectionSource
...
from camera.frame_source import FrameSource, SimpleColorSource
